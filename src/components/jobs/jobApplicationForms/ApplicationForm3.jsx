  ...
  const handleFinalSubmit = async (data) => {
    try {
      ...
      if (response.status === 200) {
        ...
        console.log("Response:", response.data.addedJob.jobID);
        localStorage.setItem("jobID", response.data.addedJob.jobID);
        setOpen(true);
      } else {
        ...
        >
          ...
          >
              ...
              >
                ...
                >
                  <div className="flex gap-2">
                    ...
                    <Input
                      {...register("salaryFrom", { required: true, min: 100 })}
                      type="number"
            ...
            <Stack sx={{ width: "100%" }}>
              ...
              >
                <Stack sx={{ width: "100%" }}>
                  <label className="block font-medium py-2">Apply Before</label>
                  <Input
                    type="date"
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Would you like to add questions to your job listing?
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
